...
For running base_implementation/main.py, you need to have Python installed. You can install it from [python.org](https://www.python.org/).

```bash
pip install sounddevice numpy matplotlib pathlib
